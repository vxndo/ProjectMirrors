...
import static com.github.vxndo7z.projectmirrors.map.MapLayout.NUMBER_OF_ROW_TILES;
import static com.github.vxndo7z.projectmirrors.map.MapLayout.TILE_HEIGHT_PIXELS;
import static com.github.vxndo7z.projectmirrors.map.MapLayout.TILE_WIDTH_PIXELS;
...
public class Tilemap {
	...
	public Tilemap(Game game, SpriteSheet spriteSheet) {
		mapLayout = new MapLayout(game);
